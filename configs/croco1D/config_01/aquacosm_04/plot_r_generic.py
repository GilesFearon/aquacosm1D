...
def do_the_plot(Chl, depth, r):
    ...
    fname_out='plot_r_generic_'+type(React.current_model).__name__+'_flx'+str(React.wc.surface_swr(0))+'_r'+str(React.MaxPhotoRate*(60.*60.*24.))+'_c'+str(React.Chl_light_abs)+'_a'+str(React.CrowdingMortality*(60.*60.*24.))+'_l'+str(React.LightDecay)+'.jpg'
...
if __name__ == "__main__":
    ...
    kappa = 0.001
    max_depth=20
    wc = water_column(kappa, max_depth, short_wave_radiation=800)
